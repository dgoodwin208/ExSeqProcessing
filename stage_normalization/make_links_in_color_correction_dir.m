function ret = make_links_in_color_correction_dir()
    ...
    for do_downsample = [true,false]
        ...
        for r_i = 1:params.NUM_ROUNDS
            src_filename = fullfile(src_dir,sprintf('%s_round%03i_%s.%s',FILEROOT_NAME,r_i,params.CHAN_STRS{1},params.IMAGE_EXT));
            ...
            dst_filename = sprintf('./%s_round%03i_%s.%s',FILEROOT_NAME,r_i,params.CHAN_STRS{1},params.IMAGE_EXT);
