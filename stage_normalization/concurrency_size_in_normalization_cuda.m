function [max_run_jobs,max_run_jobs_downsampled] = concurrency_size_in_normalization_cuda()
    ...
    if ~isfield(params,'NORM_MAX_RUN_JOBS')
        ...
        expected_mem_usage = 4 * imgsize_dbl + params.MATLAB_PROC_CONTEXT;
    ...
    if ~isfield(params,'NORM_DOWNSAMPLE_MAX_RUN_JOBS')
        ...
        max_availablemem = availablememory();
        availablemem = max_availablemem * params.USABLE_MEM_RATE;
        expected_mem_usage = 4 * downsample_imgsize_dbl + params.MATLAB_PROC_CONTEXT;
