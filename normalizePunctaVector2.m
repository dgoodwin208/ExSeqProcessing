...
save(fullfile(params.transcriptResultsDir,sprintf('%s_transcriptsv10.mat',params.FILE_BASENAME)),'transcripts','transcripts_confidence','pos');
save(fullfile(params.transcriptResultsDir,sprintf('%s_puncta_normedrois.mat',params.FILE_BASENAME)),'puncta_set','-v7.3');
