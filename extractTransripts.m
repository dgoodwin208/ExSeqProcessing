...
dir_input = 'rajlab/ExSeqCultureNormedRegged/';

% load(fullfile(dir_input,'roi_parameters_and_punctaset.mat'))
load(fullfile(dir_input,'rois_votedandglobalnormalized.mat'))
...
save(fullfile(dir_input,'transcriptsv2.mat'),'transcripts','transcripts_confidence','pos');