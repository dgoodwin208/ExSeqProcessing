...
/*#ifdef DEBUG_OUTPUT*/
    /*printf("xyScale:%d MagFactor:%d\n", sift_params.xyScale, sift_params.MagFactor);*/
...
#ifdef DEBUG_OUTPUT
        logger_->info("cudaFreeHost padded_sub_map and padded_sub_image");
#endif
...
#ifdef DEBUG_OUTPUT
        logger_->info("cudaFreeHost h_descriptors and h_padded_map_idx");
#endif
